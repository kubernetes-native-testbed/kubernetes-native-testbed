module github.com/__TB_GITHUB_ORG_NAME__/kubernetes-native-testbed/microservices/point
...
replace (
	github.com/__TB_GITHUB_ORG_NAME__/kubernetes-native-testbed/microservices/order => ../order
